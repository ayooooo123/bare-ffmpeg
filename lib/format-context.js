...
exports.OutputFormatContext = class FFmpegOutputFormatContext extends FFmpegFormatContext {
  ...
  /**
   * Flush the muxer's internal interleave buffer.
   * Call this before finalizing HLS segments to ensure all buffered
   * audio/video data has been written to the IOContext.
   */
  flush() {
    binding.flushFormatContext(this._handle)
  }
